...
import io.github.jhipster.application.repository.SegmentRepository;
import io.github.jhipster.application.repository.search.SegmentSearchRepository;
...
public class SegmentResourceIntTest {
    ...
    public void createSegment() throws Exception {
        ...
        assertThat(testSegment.isActive()).isEqualTo(DEFAULT_ACTIVE);
    ...
    public void updateSegment() throws Exception {
        ...
        Segment testSegment = segmentList.get(segmentList.size() - 1);
        assertThat(testSegment.isActive()).isEqualTo(UPDATED_ACTIVE);
