...
class SalesOrderGatlingTest extends Simulation {
    ...
    val scn = scenario("Test the SalesOrder entity")
        ...
        .repeat(2) {
            ...
            .headers(headers_http_authenticated)
            .body(StringBody("""{"id":null, "dateExpectedDelivery":"2020-01-01T00:00:00.000Z", "dateConfirmed":"2020-01-01T00:00:00.000Z", "dateSamplesExpected":"2020-01-01T00:00:00.000Z", "dateXmlExported":"2020-01-01T00:00:00.000Z", "dateModified":"2020-01-01T00:00:00.000Z", "ref":"SAMPLE_TEXT", "comment":"SAMPLE_TEXT", "reportFile":"SAMPLE_TEXT"}""")).asJSON
            .check(status.is(201))
